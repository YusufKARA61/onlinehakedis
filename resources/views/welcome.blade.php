        ...
        <div class="container"><a href="./" class="navbar-brand"><img src="img/logo.svg" alt="" class="img-fluid"></a>
          ...
          <div id="navbarSupportedContent" class="collapse navbar-collapse">
            <ul class="navbar-nav ml-auto">
                  ...
                  <!-- Link-->
                  <li class="nav-item"> <a href="faq.html" class="nav-link">Kurumsal</a></li>
                  <!-- Link-->
                  <li class="nav-item"> <a href="contact.html" class="nav-link">Özellikler</a></li>
                  <!-- Link-->
                  <li class="nav-item"> <a href="text.html" class="nav-link">İletişim</a></li>
              <li class="nav-item dropdown"><a id="pages" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Uygulamalar</a>
                <div class="dropdown-menu"><a href="faq.html" class="dropdown-item">Hakediş</a><a href="contact.html" class="dropdown-item">İhale Hazırlık</a><a href="text.html" class="dropdown-item">Yaklaşık Maliyet</a></div>
              </li>
            </ul>
            <a href="{{ route('login') }}"  class="btn btn-primary navbar-btn ml-0 ml-lg-3">Giriş </a>
          </div>
        </div>
      </nav>
    </header>
    ...
    <section class="hero">
      <div class="container mb-5">
        <div class="row align-items-center">
          <div class="col-lg-6">
            <h1 class="hero-heading mb-0">İşlerinizi dijitale <br> Taşıyın</h1>
            <div class="row">
              <div class="col-lg-10">
                <p class="lead text-muted mt-4 mb-4">Onlinehakedis ile işlerinizi dijital ortamda takip edin ve her an hazır bir hakedişe sahip olun.</p>
              </div>
            </div>
            
              <div class="form-group">
              <a href="{{ route('register') }}"  class="btn btn-primary navbar-btn ml-0 ml-lg-3">Kayıt ol </a>
              </div>
